...
for i in range(0,14):
	if i == 1:
		...
		enc.append(attr)
                ...
                attr = input(col_names[i]+"(Bachelors, HS-grad, Masters, 7th-8th, 9th, 11th, Some-college, Assoc-acdm, Assoc-voc): ")
	elif i == 5:
                attr = input(col_names[i]+"(Never-married, Married-civ-spouse, Divorced, Married-spouse-absent, Separated, Married-AF-spouse): ")
	elif i == 6:
		attr = input(col_names[i]+"(Adm-clerical, Exec-manager, Handlers-cleaners, Exec-managerial, Prof-specialty, Sales, Protective-serv, Craft-repair, Transport-moving, Farming-fishing, Machine-op-inspct, Tech-support, Other-service): ")
	elif i == 7:
